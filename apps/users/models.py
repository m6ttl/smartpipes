...
class UserProfile(AbstractUser):
    ...
    gender = models.CharField(
        ...
        default="female")
    # 地址
    address = models.CharField(max_length=100, verbose_name="地址", default="易维科技")
    # 电话
    ...
    longitude = models.FloatField(verbose_name=u"经度", blank=True, null=True)
    latitude = models.FloatField(verbose_name=u"纬度", blank=True, null=True)
