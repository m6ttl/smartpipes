...
class CourseListMView(View):
    ...
    def get(self, request):
        ...
        p = Paginator(all_course, 6, request=request)
        courses = p.page(page)
        return render(request, "course-list-m.html", {
            "all_course": courses,
            "sort": sort,
            "hot_courses": hot_courses,
            "search_keywords": search_keywords
...
class AddCommentsView(View):
    def post(self, request):
        ...
        if int(course_id) > 0 and comments:
            ...
            return HttpResponse('{"status":"success", "msg":"交流成功" }', content_type='application/json')
        else:
            return HttpResponse('{"status":"fail", "msg":"交流失败"}', content_type='application/json')
